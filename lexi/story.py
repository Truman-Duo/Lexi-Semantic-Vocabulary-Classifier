    ...
    def _build_prompt(
        ...
        if language == "zh":
            ...
            if style_profile and style_profile.avg_sentence_length > 0:
                system_msg += build_style_constraints_zh(style_profile, style_name)
            user_msg = (
            ...
            if style_profile and style_profile.avg_sentence_length > 0:
                system_msg += build_style_constraints_en(style_profile, style_name)
            user_msg = (
...
from .story_prompt import build_style_constraints_en, build_style_constraints_zh
